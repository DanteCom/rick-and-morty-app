...
class _Idle implements LocationSearchState {
  const _Idle();
...
@override
String toString() {
  return 'LocationSearchState.idle()';
}
...
class _Success implements LocationSearchState {
...
@override
String toString() {
  return 'LocationSearchState.success(response: $response)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $LocationSearchStateCopyWith<$Res> {
...
class _Error implements LocationSearchState {
...
@override
String toString() {
  return 'LocationSearchState.error(failure: $failure)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $LocationSearchStateCopyWith<$Res> {
