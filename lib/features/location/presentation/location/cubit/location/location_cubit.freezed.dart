...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( LocationResponse response,  AsyncState<AppFailure> loadMoreState)?  success,TResult Function( AppFailure failure)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( LocationResponse response,  AsyncState<AppFailure> loadMoreState)  success,required TResult Function( AppFailure failure)  error,}) {final _that = this;
switch (_that) {
case _Loading():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( LocationResponse response,  AsyncState<AppFailure> loadMoreState)?  success,TResult? Function( AppFailure failure)?  error,}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
return loading();case _Success() when success != null:
return success(_that.response,_that.loadMoreState);case _Error() when error != null:
...
class _Loading extends LocationState {
...
class _Success extends LocationState {
...
@override
String toString() {
  return 'LocationState.success(response: $response, loadMoreState: $loadMoreState)';
}
...
class _Error extends LocationState {
