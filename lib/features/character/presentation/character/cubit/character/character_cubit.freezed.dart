...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( CharacterResponse response,  AsyncState<AppFailure> loadMoreState)?  success,TResult Function( AppFailure failure)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( CharacterResponse response,  AsyncState<AppFailure> loadMoreState)  success,required TResult Function( AppFailure failure)  error,}) {final _that = this;
switch (_that) {
case _Loading():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( CharacterResponse response,  AsyncState<AppFailure> loadMoreState)?  success,TResult? Function( AppFailure failure)?  error,}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
return loading();case _Success() when success != null:
return success(_that.response,_that.loadMoreState);case _Error() when error != null:
...
class _Loading extends CharacterState {
...
class _Success extends CharacterState {
...
@override
String toString() {
  return 'CharacterState.success(response: $response, loadMoreState: $loadMoreState)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $CharacterStateCopyWith<$Res> {
...
class _Error extends CharacterState {
...
@override
String toString() {
  return 'CharacterState.error(failure: $failure)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $CharacterStateCopyWith<$Res> {
