...
class _Idle implements CharacterSearchState {
  const _Idle();
...
@override
String toString() {
  return 'CharacterSearchState.idle()';
}
...
class _Success implements CharacterSearchState {
...
@override
String toString() {
  return 'CharacterSearchState.success(response: $response)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $CharacterSearchStateCopyWith<$Res> {
...
@override
String toString() {
  return 'CharacterSearchState.error(failure: $failure)';
}
