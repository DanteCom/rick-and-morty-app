...
import 'package:rick_and_morty/features/characters/data/characters_repo_impl.dart'
    as _i904;
...
import 'package:rick_and_morty/features/characters/presentation/characters/bloc/characters_search/characters_search_bloc.dart'
    as _i787;
import 'package:rick_and_morty/features/episodes/data/episodes_repo_impl.dart'
    as _i161;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i55.CharactersRepo>(
      () => _i904.CharactersRepoImpl(dio: gh<_i361.Dio>()),
    );
    gh.lazySingleton<_i691.EpisodesRepo>(
      () => _i161.EpisodesRepoImpl(dio: gh<_i361.Dio>()),
    );
    gh.factory<_i78.CharacterDetailBloc>(
      () => _i78.CharacterDetailBloc(gh<_i55.CharactersRepo>()),
    );
    gh.factory<_i529.CharactersBloc>(
      () => _i529.CharactersBloc(gh<_i55.CharactersRepo>()),
    );
    gh.factory<_i787.CharactersSearchBloc>(
      () => _i787.CharactersSearchBloc(gh<_i55.CharactersRepo>()),
    );
    gh.factory<_i470.CharacterEpisodesBloc>(
      () => _i470.CharacterEpisodesBloc(gh<_i691.EpisodesRepo>()),
    );
    return this;
  }
}
